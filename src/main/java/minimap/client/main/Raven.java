...
import minimap.client.clickgui.kv.KvCompactGui;
import minimap.client.clickgui.raven.ClickGui;
import minimap.client.command.CommandManager;
import minimap.client.config.ConfigManager;
import minimap.client.event.forge.ForgeEventListener;
import minimap.client.module.ModuleManager;
import minimap.client.notifications.NotificationRenderer;
import minimap.client.utils.DebugInfoRenderer;
import minimap.client.utils.MouseManager;
import minimap.client.utils.PingChecker;
import minimap.client.utils.RenderUtils;
import minimap.client.utils.Utils;
import minimap.client.utils.font.FontUtil;
import minimap.client.utils.version.VersionManager;
...
public class Raven {
    ...
    public static void init() {
        ...
        mResourceLocation = RenderUtils.getResourcePath("/assets/minimap/raven.png");
