...
public class KvModuleComponent extends KvComponent{
    ...
    private final static ResourceLocation settingIcon = RenderUtils.getResourcePath("/assets/minimap/kvclickgui/gear.png");;
    ...
    public KvModuleComponent(Module module) {
        ...
        moduleIcon = RenderUtils.getResourcePath("/assets/minimap/kvclickgui/" + module.moduleCategory().getName() + "/" + module.getName().toLowerCase() + ".png");
