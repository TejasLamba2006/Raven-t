package minimap.client.module.modules.combat.aura;
...
import minimap.client.event.impl.LookEvent;
import minimap.client.event.impl.MoveInputEvent;
import minimap.client.event.impl.PacketEvent;
import minimap.client.event.impl.UpdateEvent;
...
public class KillAura extends Module {
    ...
    @Subscribe
    public void onTick(minimap.client.event.impl.TickEvent e) {
